package ua.gov.nais.dracs.pages.register.actRecordsTab.acts.marriagePage.marriagePageTabs;
...
public class MarriagePageTabFianceTab extends AbstractPage {
    ...
    public MarriagePageTabFianceeTab addFiance(Person person){
        ...
        return new MarriagePageTabFianceeTab(driver);
    }
}
